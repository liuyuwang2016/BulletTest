...
void BasicDemo::CreateObjects() {
	...
	CreateGameObject(new btBoxShape(btVector3(1,1,1)), 100000, btVector3(1.0f, 0.2f, 0.2f), btVector3(0.0f, 2.2f, 0.0f));
	
	// create a second box
	CreateGameObject(new btBoxShape(btVector3(1,1,1)), 1, btVector3(0.0f, 0.2f, 0.8f), btVector3(1.25f, 20.0f, 0.0f));
}